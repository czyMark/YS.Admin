...
namespace YS.Admin.Web.Areas.OrganizationManage.Controllers
{
    ...
    public class UserController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IActionResult> UnLockJson(string lockpwd)
        {
            TData<long> obj = await userBLL.UnLockJson(lockpwd);
            return Json(obj);
        }

        [HttpPost]
        public async Task<IActionResult> UnLockByIdJson(string Id)
        {
            TData<long> obj = await userBLL.UnLockByIdJson(Id);
            return Json(obj);
        }
        [HttpPost]
