/**
 * 首页方法封装处理
 * Copyright (c) 2019 ruoyi YS.Admin  
 */
$(function () {
    // MetsiMenu
    $('#side-menu').metisMenu();
...
$(function () {
    ...
    $('.menuItem').on('click', function menuItem() {
        ...
        if (addMenuTab) {
            ...
            // 添加选项卡对应的iframe
            var ifrmaeStr = '<iframe class="YS_iframe" name="iframe' + dataIndex + '" width="100%" height="100%" src="' + dataUrl + '" frameborder="0" data-id="' + dataUrl + '" seamless></iframe>';
            $('.mainContent').find('iframe.YS_iframe').hide().parents('.mainContent').append(ifrmaeStr);
