...
(function ($, ys) {
    ...
    $.extend(ys, {
        ...
        openDialogFull: function (option) {
        ...
        openDialogParent: function (option) {
            if (ys.isMobile()) {
                option.width = 'auto';
                option.height = 'auto';
            }
        ...
        msgSuccess2: function (content,time) {
            if (ys.isNullOrEmpty(content)) {
                content = "操作成功";
            }
            top.layer.msg(content, { icon: 1, time: time, shift: 5 });
        },
