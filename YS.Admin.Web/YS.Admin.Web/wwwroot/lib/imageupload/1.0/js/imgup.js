...
(function ($) {
    ...
    var defaults = {
        fileType: ["jpg", "jpg", "png", "bmp", "jpeg", "jfif", "mp4", "pdf"],   // 上传文件的类型
    ...
    $.fn.imageUpload = function (option, param) {
        ...
        //html += '           <input type="file" name="' + inputFileId + '" id="'
        //    + inputFileId + '" class="file-image" callback="' + _option.uploadImage
        //    + '" context="' + _option.context
        //    + '" limit="' + _option.limit
        //    + '"  value="" accept="image/jpg,image/jpeg,image/png,image/bmp" />';

        html += '           <input type="file" name="' + inputFileId + '" id="' + inputFileId
