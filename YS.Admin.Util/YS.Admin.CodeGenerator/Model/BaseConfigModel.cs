...
namespace YS.Admin.CodeGenerator.Model
{
    ...
    public class PageIndexModel
    {
        ...
        public List<TableFieldInfo> ColumnList { get; set; }
        public List<TableFieldInfo> SearchList { get; set; }
    }
    public class PageFormModel
    {
        ...
        public List<TableFieldInfo> FieldList { get; set; }
    }
}
